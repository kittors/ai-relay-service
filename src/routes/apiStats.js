  ...
  try {
    ...
    try {
      ...
      try {
        ...
        const dailyReqKey = `rate_limit:daily_requests:${keyId}:${todayStr}`
        currentDailyRequests = parseInt((await client.get(dailyReqKey)) || '0') || 0
      } catch (e) {
    ...
    const responseData = {
      ...
      limits: {
        ...
        dailyRequestsLimit: parseInt(fullKeyData.dailyRequestsLimit || 0) || 0,
