...
const dailyRotateFileTransport = createRotateTransport('ai-relay-%DATE%.log')
const errorFileTransport = createRotateTransport('ai-relay-error-%DATE%.log', 'error')

// 🔒 创建专门的安全日志记录器
const securityLogger = winston.createLogger({
  level: 'warn',
  format: logFormat,
  transports: [createRotateTransport('ai-relay-security-%DATE%.log', 'warn')],
  silent: false
})
...
const authDetailLogger = winston.createLogger({
  ...
  transports: [createRotateTransport('ai-relay-auth-detail-%DATE%.log', 'info')],
  silent: false
})
