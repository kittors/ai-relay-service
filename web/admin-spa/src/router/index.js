...
const ApiKeysView = () => import('@/views/ApiKeysView/index.vue')
const AccountsView = () => import('@/views/AccountsView/index.vue')
const TutorialView = () => import('@/views/TutorialView.vue')
const SettingsView = () => import('@/views/SettingsView/index.vue')
const ApiStatsView = () => import('@/views/ApiStatsView/index.vue')
